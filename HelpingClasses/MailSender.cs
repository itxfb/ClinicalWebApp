    ...
    public class MailSender
    {
        ...
        public static bool SendForgotPasswordEmail(string email, int id, string BaseUrl = "")
        {
            try
            {
                ...
                request.AddParameter("subject", "Open Bio | Password Reset");
        ...
        public static bool SendConfirmationLetterEmail(string email,string confirmationLetter="", string BaseUrl = "")
        {
            try
            {
                //string MailBody = "<html>" +
                ...
                request.AddParameter("from", ProjectVariables.FromEmail);
                request.AddParameter("to", email);
                request.AddParameter("subject", "Open Bio | Confirmation Letter");

                request.AddParameter("html", confirmationLetter);
        ...
        public static bool SendFollowupLetterEmail(string email, string confirmationLetter = "", string BaseUrl = "")
        {
            try
            {
                //string MailBody = "<html>" +
                ...
                request.AddParameter("from", ProjectVariables.FromEmail);
                request.AddParameter("to", email);
                request.AddParameter("subject", "Open Bio | Follow Up Letter");
